...
sudo scutil --set ComputerName "m02"
sudo scutil --set HostName "m02"
sudo scutil --set LocalHostName "m02"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "m02"
