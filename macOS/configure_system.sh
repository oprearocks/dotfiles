...
sudo scutil --set ComputerName "m01"
sudo scutil --set HostName "m01"
sudo scutil --set LocalHostName "m01"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "m01"
